$(document).ready(function(){
    ...
    var settings =  '<a id="settings" href="#changeSkin" data-toggle="modal">' +
			'<i class="fa fa-gear"></i> Proyectos' +
		    '</a>' +   
			...
			'<div class="modal-dialog modal-lg">' +
				...
				'<div class="modal-header">' +
				    ...
				    '<h4 class="modal-title">Cambiar</h4>' +
				'</div>' +
...
-----------------------------------------------------------*/
(function(){
    var monthNames = [ "January", "February", "March", "April", "May", "June", "July", "August", "September", "Octubre", "November", "December" ];
