    ...
    public function guardarRestoLlamada($data){
     ...
     try{ 
            ...
            if(isset($data->agendar_cita))
            {
               ...
               $this->php->email($data->id_cliente, $data->agendar_cita,$data->id_tipo_llamada,'m.orozco@siaisa.com.mx,cesar4085@live.com.mx,daniel.diaz.1@bbva.com,f.grego@bbva.com,tanyapamela.cantu@bbva.com');
            }
