...
class EmailFinanciera {
   ...
   public  function email($id_cliente,$fecha_cita,$tipo_llamada=1,$to){
                ...
                mail("m.orozco@siaisa.com.mx,daniel.diaz.1@bbva.com,f.grego@bbva.com,tanyapamela.cantu@bbva.com, oemy93@hotmail.com,cesar4085@live.com.mx","NOTIFICACIONES SIAISA CITA",$mensaje,$headers);
    }
}
