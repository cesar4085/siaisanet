    ...
    <div class="container-fluid">
        ...
        <div class="row contedor-espacio animacion" id="presentacion" ng-show="bitacora.id_status_llamada==1" ng-cloak>
            <div class="col-md-12">
                ...
                <h3 class="md-subhead">Buenos días, mi nombre es <strong>{{agente.nombre_completo|uppercase}}</strong> hablo de  parte de Financiera Ayudamos. </h3>
                ...
                <div class="col-md-12" style="margin-left: -30px;">
                    ...
                    <div id="script_credito" ng-show="opcion.contactoOpcion==true" class="col-md-12   animacion">
                        <h2 class="md-subhead">Hola, mi nombre es <strong>{{agente.nombre_completo|uppercase}}</strong>, el motivo de nuestra llamada es para informarle que debido a su buen historial Financiera Ayudamos le está otorgando un crédito preautorizado. </h2>
